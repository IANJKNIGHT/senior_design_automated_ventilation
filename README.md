...
| :--- | :--- | :--- | :--- |
| **Week 4: Component Benchtop** | • Implement PWM driver for 4-wire fans<br>• Connect to INA219 current sensors using I2C<br>• Monitor Temperature and Humidity using DHT sensors| • <br>• Bench-test MPPT charge controller<br>• Validate stable 3.3V/5V/12V rails | **Gateway 1:** Verify power rails drive ESP32 and actuators under simulated max load. |
