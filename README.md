...
| :--- | :--- | :--- | :--- |
| **Phase 1: Component Benchtop** | • Implement PWM driver for 4-wire fans<br>• Calibrate servo sweep limits for louvers<br>• Write I2C sensor drivers | • Size solar panel & battery capacities<br>• Bench-test MPPT charge controller<br>• Validate stable 3.3V/5V/12V rails | **Gateway 1:** Verify power rails drive ESP32 and actuators under simulated max load. |
| **Phase 2: Closed-Loop Automation** | • Implement PID loop for thermal regulation<br>• Add tachometer feedback for fan speed<br>• Configure low-power sleep triggers | • Implement battery voltage monitor (ADC)<br>• Add low-voltage cutoff/protection circuit<br>• Log solar panel charging currents | **Gateway 2:** ESP32 autonomously adjusts ventilation based on sensor input using solar power. |
